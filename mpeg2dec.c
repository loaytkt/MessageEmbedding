...
/* Copyright (C) MPEG Software Simulation Group. All Rights Reserved. */
...
char *argv[];
{
    ...
    // NEW CODE ==== START ==============================
    // Output file to print the extracted bits, the file is closed at the end of main()
    extracted_msg = fopen("extracted.txt", "w");
